...
ggtree(t30)+geom_nodelab()+geom_tiplab() + xlim(0,1)
```
...
ggtree(t33)+geom_nodelab()+geom_tiplab() + xlim(0,0.5)
```
...
ggtree(t34)+geom_nodelab()+geom_tiplab() + xlim(0,1)
```
...
ggtree(t36)+geom_nodelab()+geom_tiplab() + xlim(0,.5)
```
...
ggtree(t45)+geom_nodelab()+geom_tiplab() + xlim(0,1)
```
...
ggtree(t46)+geom_nodelab()+geom_tiplab() + xlim(0,1)
```
...
ggtree(t50)+geom_nodelab()+geom_tiplab()+xlim(0,.5)
```
...
ggtree(t51)+geom_nodelab()+geom_tiplab()+xlim(0,.15)
```
...
ggtree(t53)+geom_nodelab()+geom_tiplab()+xlim(0,.5)
```
...
ggtree(t65)+geom_nodelab()+geom_tiplab()+xlim(0,.5)
```
...
ggtree(t66)+geom_nodelab()+geom_tiplab()+xlim(0,.5)
```